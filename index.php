<!-- This class serves as the main page of the website for both the users and the admin-->

<!-- This php code block is what connects the website to the database via the "connection.php" class
& is responsible for the log in -->
<?php
...
// The if statement and everything in it is responsible for the log in and validation.
if($_SERVER['REQUEST_METHOD'] == "POST") {
    
		// Stored the inputed data from the admin in a variable.
		$user_name = $_POST['user_name'];
		$password = $_POST['password'];

    // Checking if both field are not empty
		if(!empty($user_name) && !empty($password) && !is_numeric($user_name)) {

			// if the field are not empty --> Read from database and if data is correct give access.
      ...
      // An alert will appear if data is wrong and access will be denied.
			echo '<script> alert("اسم المستخدم أو رقم السري خاطئ") </script>';
		}
    // If field are empty an alert will appear to notify the admin.
    else {
...
<head>
  ...
  <!-- Link the website to the CSS File -->
...
function filterFunction() {
  ...
  <main id="main">
    <!-- ======= Counts Section ======= -->
    <section id="counts" class="counts  section-bg" style="padding-left: 20%">
      <div class="container" >
        ...
        <div class="row no-gutters">
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong style="font-size: 25px">الأدوار</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <span data-purecounter-start="0" data-purecounter-end="104" data-purecounter-duration="1" class="purecounter"></span>
              <p><strong style="font-size: 25px">المكاتب</strong></p>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
              ...
              <p><strong style="font-size: 25px">منسوبات الكلية</strong></p>
            </div>
          </div>
        </div>
      </div>
...
<img src="assets/img/floor.jpg"  style="right; width: 60%; margin-left:20%;" id="img-floor">
 ...
 <!-- ======= About Section ======= -->
    ...
    <!-- This section contains the frontend of the log in prompt and button-->
    <!-- ======= Contact Section ======= -->
    <section id="contact" class="contact section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>تسجيل دخول</h2>
          <p>تسجيل دخول لمسؤولة المكاتب</p>
        </div>
		...
		<button type="submit"value="Login" style="box-shadow: 0 0 30px rgba(214, 215, 216, 0.6);
                                              ...
                                              text-decoration: none;
                                              color: #fff;"
        name="login_button">تسجيل دخول</button>
		</a>
		</div> 
            </form>
          </div>
  ...
  <!-- Footer contains basic information about the college -->
  <!-- ======= Footer ======= -->
  <footer id="footer">
